...
public class Customer 
{
    ...
    public Customer(String companyName, String email, String telephone, String notes) {
	 ...
	 */
	public Customer(int customerId, String companyName, String email,
	 ...
	 */
	public Customer(int customerId, String companyName, String notes)
	{
